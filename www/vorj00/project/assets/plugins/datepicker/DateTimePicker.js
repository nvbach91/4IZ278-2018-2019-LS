/*JS na výběr data - netvořil jsem já */
/* ----------------------------------------------------------------------------- 
...
/*
Účel: Výběr data při plánování akce
Vytvoření: viz výše
Historie úprav:
Úprava: JV 25.2.2017 12:20:35 - přizpůsobení vzhledu a správného formátování
...
$.DateTimePicker = $.DateTimePicker || {
	...
	defaults:  //Plugin Defaults
	{
		...
		shortDayNames: ["Neděle", "Pondělí", "Úterý", "Středa", "Čtvrtek", "Pátek", "Sobota"],
		...
		titleContentDateTime: "Nastav datum a čas",
