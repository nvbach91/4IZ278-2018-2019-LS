...
<head>
    ...
    <link rel="shortcut icon" href="./images/site/bc_favicon.ico">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <?php if (isset($_SESSION['band_id'])): ?>
                    ...
                    <li class="nav-item<?php echo strpos($_SERVER['REQUEST_URI'], 'user_search') ? ' active' : '' ?>">
                        <a class="nav-link" href="user_search.php">Vyhledej hudebníka</a>
                    </li>
                ...
                <?php elseif(isset($_SESSION['user_id'])): ?>
                    ...
                    <li class="nav-item<?php echo strpos($_SERVER['REQUEST_URI'], 'user_change_profile') ? ' active' : '' ?>">
                        <a class="nav-link" href="user_change_profile.php"><i
                                    class="fas fa-user"></i> <?php echo $_SESSION['email']; ?></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="signout.php"><i class="fas fa-sign-out-alt"></i></a>
